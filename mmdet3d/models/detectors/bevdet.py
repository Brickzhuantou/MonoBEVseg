...
class BEVDetSeg(CenterPoint):
    ...
    def __init__(self, img_view_transformer, img_bev_encoder_backbone,
        ...
        super(BEVDetSeg, self).__init__(**kwargs)
    ...
    def forward_pts_train(self,
        ...
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, semantic_indices, outs]
    ...
    def simple_test(self,
        ...
        bbox_pts, pred_map_indices = self.simple_test_pts(img_feats, img_metas, rescale=rescale)
    ...
    def simple_test_pts(self, x, img_metas, rescale=False):
        ...
        # 获取bev语义map的测评格式
        pred_semantic_indices = self.pts_bbox_head.get_map_indices(outs[1], img_metas)
        ...
        return bbox_results, pred_semantic_indices
...
class BEVSeg(CenterPoint):
    ...
    def __init__(self, img_view_transformer, img_bev_encoder_backbone,
                 img_bev_encoder_neck, **kwargs):
        super(BEVSeg, self).__init__(**kwargs)
        self.img_view_transformer = builder.build_neck(img_view_transformer)
        self.img_bev_encoder_backbone = \
            builder.build_backbone(img_bev_encoder_backbone)
        self.img_bev_encoder_neck = builder.build_neck(img_bev_encoder_neck)
